...
int main(int argc, char *argv[]) {
  ...
  while (reps > 0) {
    ...
    if (reps == 2) {
      ...
      printf("Which operation for the second operation? Blur (1), Edge (2), Emboss (3) ");
      scanf("%d",&params2[0]);
      ...
      printf("Which operation for the first operation? Blur (1), Edge (2), Emboss (3) ");
      scanf("%d",&params1[0]);
      printf("Enter all %d coefficients in order from left to right with an enter after each.\n",params1[5]);
